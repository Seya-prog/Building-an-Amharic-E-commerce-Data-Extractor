...
# Import only the clean_amharic_text function, skip other imports that require API credentials
...
class TestDataPipeline(unittest.TestCase):
    ...
    @unittest.skip("Skipping data preprocessing test that requires API credentials")
    ...
    @unittest.skip("Skipping view count test that requires API credentials")
